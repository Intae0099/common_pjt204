    ...
    async def vector_search(self, query: str, page: int = 1, size: int = 10, use_rerank: bool = True) -> tuple[list[dict], int]:
        ...
        try:
            ...
            with conn.cursor() as cur:
                ...
                cur.execute(
                    """
                    SELECT lc.case_id, lc.title, lc.decision_date, lc.category, lc.issue, lc.summary, lc.full_text
                ...
                initial_results = [
                    ...
                    for cid, title, decision_date, category, issue, summary, full_text in cur.fetchall()
                ]
