...
|  | Visual Studio Code | `[ VSCode 버전 ]` | Vue 개발용 확장 프로그램: `[ 예: Volar, ESLint ]` |
| **언어 (Language)** |  |  |  |
...
| --- | --- | --- | --- | --- | --- |
| **카카오 소셜 로그인** | 사용자 인증 | https://developers.kakao.com/ | rbtjd1478
@naver.com | **~~REST API 키:** `[ 발급받은 키 ]`
**Client Secret:** `[ 발급받은 시크릿 ]`~~ | **Redirect URI:**
`https://i13b204.p.ssafy.io/api/login/oauth2/code/kakao` |
| **OpenVidu** | 화상 통화 | 자체 호스팅 (Self-hosted) | - | **OPENVIDU_SECRET:** ssafy204openvidulawaid | **DOMAIN_OR_PUBLIC_IP:** 
https://i13b204.p.ssafy.io/openvidu |
...
네, 제공해주신 내용을 바탕으로 마크다운 표 형식으로 정리해 드리겠습니다.
