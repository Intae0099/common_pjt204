    ...
    template = """
        ...
        * 결론 제시  
        ...
        "data": {{
            ...
            "opinion": "○○사건(2020다12345)에서 법원은 '계약상 기망행위 시 피해 회복이 가능하다'고 판시한 바, 본 사건 역시 유사한 피해 회복이 가능한 것으로 예상된다.",
            "sentencePrediction": "기망행위 인정으로 징역 8월에서 1년 6월이 예상된다.",
            "confidence": 0.84,
            "references": {{
                "cases": [
                ...
                {{ "id": 93810, "title": "소유권이전등기말소", "decision_date": "1978-01-01", "category": "일반 행정", "chunk_summary": "방문판매등에관한법률 제2조 제5호에서 정한 '판매조직에 가입한 판매원의 단계가 3단계 이상'의 의미" }},
                {{ "id": 93810, "title": "소유권이전등기말소", "decision_date": "1978-01-01", "category": "일반 행정", "chunk_summary": "방문판매등에관한법률 제2조 제5호에서 정한 '판례조직에 가입한 판매원의 단계가 3단계 이상'의 의미" }}
                ]
            }}
            }}
        }},
        "statutes": [
            {{ "code": "형법", "article": "347조" }}
        ],
        "tags": ["사기", "계약분쟁", "소비자보호"]
        }}
        ...
        * **statutes 배열은 사건과 관련된 법령을 반드시 포함해야 합니다.** 형사 사건의 경우 "형법", 민사 사건의 경우 "민법", 상거래의 경우 "상법"등 해당하는 법령의 code와 관련 조항의 article을 명시하십시오.
        ...
        **4. 금지된 태그 예시**
        ...
        ⚠️ **법령 사용 규칙**: 반드시 [관련 법령 정보]에서 제공된 법령만 사용하십시오.
        
        **1. 법령 참조 원칙**
        - [관련 법령 정보]에 나열된 법령만 statutes에 포함하십시오.
        - 제공되지 않은 법령은 절대 사용하지 마십시오.
        - 법령명은 [관련 법령 정보]의 정확한 명칭을 사용하십시오.
        
        **2. 조항 정보 처리**
        - articles 배열에는 동일 법령의 여러 조항을 포함할 수 있습니다.
        - 예: "articles": ["347조(사기)", "350조(공갈)"]
        - 조항 정보가 불명확한 경우 빈 배열 사용: "articles": []
        
        **3. 법령 정보 포함 필수**
        - statutes는 최소 1개 이상 포함해야 합니다.
        - [관련 법령 정보]가 제공된 경우 반드시 활용하십시오.
        - 사건과 관련성이 높은 순서로 정렬하십시오.
